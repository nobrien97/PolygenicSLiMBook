...
```{r out.width="100%", fig.link='./images/chapter2/slimgui.PNG', echo = F}
knitr::include_graphics('./images/chapter2/slimgui.PNG')
```
...
```{r out.width="100%", fig.link='./images/chapter2/desktopapps.PNG', echo = F}
knitr::include_graphics('./images/chapter2/desktopapps.PNG')
```
