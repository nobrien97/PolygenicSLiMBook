...
- Installing SLiM (with some fixes for errors I have come across),
    ...
    Installing SLiM - building from source
    Troubleshooting - black screen, .bashrc fix
    Additional useful software - R, RStudio, FileZilla, Visual Studio Code, Ranger
- Polygenic adaptation crash course - featuring videos, animations, shiny apps
    What is polygenic adaptation?
    Quantitative vs population genetics (introduction - subsections go into more detail)
    Neutral theory of molecular evolution and how it fits into quantitative traits
