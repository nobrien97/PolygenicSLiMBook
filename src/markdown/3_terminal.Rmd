...
start at your home directory. To check your current working 
...
``` {bash fortune3, eval = F}
fortune

cowsay "I don't think, therefore I don't am."
```
``` {bash fortune3_2, echo = F}
/usr/games/fortune

/usr/games/cowsay "I don't think, therefore I don't am."
```
