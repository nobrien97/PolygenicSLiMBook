...
One problem with this is file size. With more frequent sampling and more data, you'll end up with
...
Another option is to compress your output. SLiM does have an option to save as binary
