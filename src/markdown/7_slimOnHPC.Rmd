...
so our output will be there. The files will be named the same as your PBS script, with .eXXXXX and .oXXXXX, where XXXXX is your job's id 
number.
...
But we're still only using one node. We can access multiple nodes in a job and use many more 
