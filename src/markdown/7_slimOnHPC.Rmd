...
$t_(w) = t_s * (n_p * n_r)$
Where $t_s$ is the time taken for a single run, $n_p$ is the number of parameter combinations, and $n_r$ is the number of replicates.
...
if you are working on a HPC with 120 GB of available memory and 24 cores, that is $120/24 = 5$ GB of memory per core, so your simulations 
